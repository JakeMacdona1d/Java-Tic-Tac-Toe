 ...
 * @version 2.0
 */
public final class WinView extends JFrame implements ActionListener {
     ...
     */
    public WinView(char player) {
        //call super constructor to make JFrame

        // JFrame frame = new JFrame("Game Conclusion");


        super("Game Conclusion");
        ...
        this.message = new JTextArea("It is X\'s turn. ");
